...
pub fn serialize(schema: &TableSchema, row: &Row) -> Result<Vec<u8>, Box<dyn Error>> {
    ...
    let op_type = match row.kind {
        ...
        seatunnel_api::RowKind::UpdateBefore | seatunnel_api::RowKind::UpdateAfter => "MODIFY".to_string(),
        _ => "INSERT".to_string(),
    };
